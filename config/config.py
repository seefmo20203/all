...
API_ID = int(getenv("API_ID", "6273613008"))
API_HASH = getenv("API_HASH", "d3af44df9cfcbd0da97a23cbf7307123")
BOT_TOKEN = getenv("BOT_TOKEN", "5976328843:AAHbEVmdKtT8THDYJ88is471Oq1-Av_JDzE")
...
BOT_USERNAME = getenv("BOT_USERNAME", "FR_MUSICBOT")
COMMAND_PREFIXES = list(getenv("COMMAND_PREFIXES", "/ ! .").split())
SUDO_USERS = list(map(int, getenv("SUDO_USERS", "-1887918785").split()))
OWNER_ID = list(
...
BOT_NAME = getenv("BOT_NAME", "FRMusic")
